package com.studybranch.ResideMenu;
...
public class ResideMenu extends FrameLayout{
    ...
    private void setShadowAdjustScaleXByOrientation(){
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            shadowAdjustScaleX = 0.005f;
            shadowAdjustScaleY = 0.002f;
    ...
    public void setShadowVisible(boolean isVisible){
        if (isVisible)
            imageViewShadow.setBackgroundResource(R.drawable.shadow_shape);//change from shadow.png
        else
    ...
    private boolean isInIgnoredView(MotionEvent ev) {
        ...
        if(ev.getX()>30){
            //Dead Zone so that we can still have tab viewPager.
            return true;
        }
        return false;
    }
